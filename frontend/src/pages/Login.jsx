...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate API Call
    setTimeout(() => {
      alert(`ACCESS GRANTED TO: ${formData.username}`);
      setLoading(false);
    }, 2000);
  };
        ...
        <div className="flex max-w-6xl w-full bg-gray-900/90 backdrop-blur-xl rounded-3xl shadow-[0_0_80px_rgba(168,85,247,0.4)] border border-purple-500/50 overflow-hidden floating-card">
            ...
            <div className="hidden lg:flex w-5/12 relative overflow-hidden image-container group cursor-pointer">
                ...
                <div className="relative z-10 p-10 flex flex-col justify-between h-full">
                    <div className="border-l-4 border-pink-500 pl-6">
                        <h2 className="text-5xl font-black text-white tracking-tighter drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] glitch" data-text="ZORDON">
                            ZORDON
                        </h2>
                    ...
                    <div className="bg-black/60 backdrop-blur-md p-6 rounded-2xl border border-purple-500/30 transform group-hover:translate-x-2 transition-transform duration-300">
                        <p className="text-pink-300 text-sm font-semibold tracking-widest mb-2">STATUS: CRITICAL</p>
                        <p className="text-gray-300 text-sm leading-relaxed">
                            "Alpha, recruit a team of teenagers with attitude. The grid connection is stable."
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-7/12 p-10 md:p-16 relative">
                ...
                <div className="absolute top-0 right-0 p-6 opacity-30">
                    <svg className="w-24 h-24 text-purple-600 animate-spin" style={{ animationDuration: '10s' }} viewBox="0 0 100 100">
                ...
                <div className="mb-10">
                    <h3 className="text-4xl font-bold text-white mb-2 tracking-wide">IDENTITY VERIFICATION</h3>
                    <p className="text-purple-400/80 uppercase tracking-[0.2em] text-sm">Enter Access Codes</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex justify-between items-center text-sm">
                        <label className="flex items-center text-gray-400 cursor-pointer hover:text-white transition">
                            <input type="checkbox" className="mr-2 accent-purple-600 h-4 w-4" /> Remember Signal
                        </label>
                        <a href="#" className="text-pink-500 hover:text-pink-300 hover:shadow-[0_0_10px_#ec4899] transition-all">Breached Protocol?</a>
                    </div>
                    ...
                    >
                        {loading ? 'CONNECTING TO GRID...' : 'INITIATE MORPHIN SEQUENCE'}
                    </button>

                    <div className="mt-8 text-center">
                        <button type="button" className="text-gray-500 hover:text-white transition-colors text-sm uppercase tracking-widest border-b border-transparent hover:border-purple-500 pb-1">
